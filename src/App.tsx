          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 backdrop-blur-sm bg-black/60">
            ...
            >
              <div className="text-center mb-6">
                ...
                <p className="text-sm text-neutral-400 mt-1">Enter password to edit blog</p>
              </div>
              <div className="space-y-4">
                <div className="relative">
                  <input 
                    ...
                    className={`w-full px-5 py-3.5 rounded-xl bg-neutral-800/50 border text-white placeholder-neutral-500 focus:outline-none focus:ring-1 focus:ring-brand-700 pr-12 ${
                ...
                {passwordError && <p className="text-red-400 text-sm">Incorrect password. Try again.</p>}
                <button 
